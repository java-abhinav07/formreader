...
class Config(object):
    ...
    MODEL_DIR = (
        "/content/drive/My Drive/IITB_Assignment/checkpoints_2020-08-27 06:25:03.598532"
    )
    ...
    TARGET_VOCAB_SIZE = 30  # 0: PADDING, 1: GO, 2: EOS, >2: 0-9, a-z
    CHANNELS = 1  # number of color channels from source image (1 = grayscale, 3 = rgb)

    MAX_WIDTH = 2000 # images with higher width will be discarded!!! --> fix now
    MAX_HEIGHT = 100
    MAX_PREDICTION = 50
